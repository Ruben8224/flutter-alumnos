...
class AuthController {
  ...
  Future<Map<String, String>> registration(
    ...
    if (AuthValidator.isMatriculaValid(matricula) != null) {
      result["message"] = "Wrong Matricula";
      result["next"] = "not";
      return result;
    }

    if (AuthValidator.isCarreraValid(carrera) != null) {
      result["message"] = "Wrong Carrera";
      result["next"] = "not";
      return result;
    }

    final user = User("20", name, email, password, matricula, carrera);
    try {
